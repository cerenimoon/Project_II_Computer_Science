...
VGG16 mimarisi veri setine (FFHQ) uyarlanarak yüz görüntülerinden benzer öznitelikler çıkarılmıştır ve K-En Yakın Komşuluk (KNN) gibi algoritmalar kullanılarak benzer yüz öznitelikleri gruplanmıştır. 
